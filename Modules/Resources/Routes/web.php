...
Route::name('resources.')->prefix('resources')->middleware([GuestAccessMiddleware::class, 'verified'])->group(function (
    ...
    Route::get('drafts',
        ResourcesDrafts::class)->middleware(['auth'])->withoutMiddleware([GuestAccessMiddleware::class])->name('drafts');
    Route::get('published',
        ResourcesPublished::class)->middleware(['auth'])->withoutMiddleware([GuestAccessMiddleware::class])->name('published');
