            ...
            @if($links)
                <div class="flex my-4 space-x-4">
                    ...
                    <a href="{{ $links['facebook'] }}" target="_blank">
                        <div class="border hover:bg-[#1877f2] w-12 h-12 fill-[#1877f2] hover:fill-primary border-secondary-light rounded-full flex items-center justify-center shadow-xl hover:shadow-secondary/50 cursor-pointer">
                    ...
                    <a href="{{ $links['twitter'] }}" target="_blank">
                        <div class="border hover:bg-[#1d9bf0] w-12 h-12 fill-[#1d9bf0] hover:fill-primary border-secondary-light rounded-full flex items-center justify-center shadow-xl hover:shadow-sky-500/50 cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path
                    ...
                    <a href="{{ $links['reddit'] }}" target="_blank">
                        <div class="text-[#FF4500] hover:text-primary border hover:bg-[#FF4500] w-12 h-12 fill-[#FF4500] hover:fill-primary border-secondary-light rounded-full flex items-center
                            justify-center
                            shadow-xl
                    ...
                    <a href="{{ $links['whatsapp'] }}" target="_blank">
                        ...
                        <div class="border hover:bg-[#25D366] w-12 h-12 fill-[#25D366] hover:fill-primary border-green-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-green-500/50 cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <a href="{{ $links['telegram'] }}" target="_blank">
                        <div class="border hover:bg-[#229ED9] w-12 h-12 fill-[#229ED9] hover:fill-primary border-sky-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-sky-500/50 cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path
