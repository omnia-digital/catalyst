@php use Filament\Navigation\NavigationGroup; @endphp
...
@php
    $openSidebarClasses = 'fi-sidebar-open max-w-none translate-x-0 shadow-xl ring-1 ring-gray-950/5 rtl:-translate-x-0';
...
<aside
        ...
        @endif
        @class([
            'fi-sidebar fixed inset-y-0 start-0 z-30 grid h-screen w-[--sidebar-width] content-start overflow-hidden bg-white transition-all lg:z-0 lg:bg-transparent lg:shadow-none lg:ring-0',
...
>
    ...
    >
        {{ FilamentView::renderHook('panels::sidebar.nav.start') }}
        ...
        @if (filament()->hasNavigation())
            ...
            @php
                $collapsedNavigationGroupLabels = collect($navigation)
                    ->filter(fn (NavigationGroup $group): bool => $group->isCollapsed())
        ...
        {{ FilamentView::renderHook('panels::sidebar.nav.end') }}
    </nav>

    {{ FilamentView::renderHook('panels::sidebar.footer') }}
</aside>
