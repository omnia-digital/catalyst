@php
    use Filament\Support\Enums\Alignment;use Filament\Support\Facades\FilamentAsset;
@endphp
                                        ...
                                        <div class="space-y-6 p-4">
                                            <div class="w-full space-y-3">
                                                @foreach ([
                                                    ...
                                                    >
                                                        <span
                                                                class="flex w-20 flex-shrink-0 items-center justify-center self-stretch border-e border-gray-300 px-2"
                                                        >
                                                            {{ $input['label'] }}
                                                        </span>
                                                        ...
                                                        <input
                                                                @class([
                                                                    'block w-full border-none text-sm transition duration-75 focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500 disabled:opacity-70',
                                                                ])
