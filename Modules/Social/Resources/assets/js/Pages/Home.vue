  ...
  <div class="my-6 lg:grid lg:grid-cols-9 lg:gap-9">
    <div class="lg:col-span-6 xl:col-span-6">
      <div class="px-4 sm:px-0">
        <div class="sm:hidden">
          <label class="sr-only" for="question-tabs">Select a tab</label>
        ...
        <div class="hidden sm:block">
          <nav aria-label="Tabs" class="relative z-0 rounded-lg shadow flex divide-x divide-gray-200">
            <a v-for="(tab, tabIdx) in tabs" :key="tab.name" :aria-current="tab.current ? 'page' : undefined"
               ...
               :href="tab.href">
              <span>{{ tab.name }}</span>
              <span :class="[tab.current ? 'bg-rose-500' : 'bg-transparent', 'absolute inset-x-0 bottom-0 h-0.5']"
                    aria-hidden="true"/>
            </a>
          </nav>
        </div>
      ...
      <div class="mt-4">
        <new-post-box :user="user" class="my-6"></new-post-box>
