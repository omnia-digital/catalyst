    ...
    <div wire:init="load" class="md:mr-4">
        ...
        <div class="flex justify-between pt-2 space-x-4">
            <div class="w-full flex space-x-4">
                ...
                <a href="https://www.igdb.com/" class="flex hover:underline items-center" target="_blank"><p
                            class="text-sm text-neutral-dark flex items-center">powered by IGDB/Twitch</p></a>
            </div>
            <div class="flex w-1/4 space-x-2">
                <a href="https://www.igdb.com/games/new" class="w-1/2" target="_blank">
                    <x-library::button class="w-full h-full">Add Game</x-library::button>
                </a>
                <a href="https://www.igdb.com/companies/new" class="w-1/2" target="_blank">
                    <x-library::button class="w-full h-full">Add Company</x-library::button>
                </a>
            </div>
        </div>
        <div>
