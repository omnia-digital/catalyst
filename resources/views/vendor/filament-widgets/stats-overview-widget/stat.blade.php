@php
    use Filament\Support\Enums\IconPosition;use Filament\Support\Facades\FilamentAsset;use function Filament\Support\get_color_css_variables;
    ...
    $descriptionIconStyles = \Illuminate\Support\Arr::toCssStyles([
        get_color_css_variables($descriptionColor, shades: [500]) => $descriptionColor !== 'gray',
    ]);
@endphp
    ...
    @if ($description = $getDescription())
        <div class="flex items-center gap-x-1">
            ...
            <span
                    ...
                    @style([
                        get_color_css_variables($descriptionColor, shades: [400, 600]) => $descriptionColor !== 'gray',
                    ])
                >
                    {{ $description }}
                </span>
...
@if ($chart = $getChart())
    ...
    <div x-data="{ statsOverviewStatChart: function () {} }">
        <div
                ...
                @style([
                    get_color_css_variables($chartColor, shades: [50, 400, 500]) => $chartColor !== 'gray',
                ])
        >
