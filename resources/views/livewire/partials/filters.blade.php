<div class="bg-white px-4 rounded-lg mb-6 border-t border-b border-gray-100 py-2 sm:flex sm:items-center sm:justify-between">
    <div class="flex-1 min-w-0">
        <div class="filters flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6">
            <div class="w-full md:w-1/2 relative">
                <x-library::input.text type="search" wire:model.debounce.500ms="search" placeholder="Find episodes" class="px-4 py-2 pl-8 bg-blue border-1 border-red"/>
