...
<div
        x-data="{
        selectedItems: @entangle($attributes->wire('model')).live,
        ...
        <div class="flex flex-col items-center relative">
                ...
                <div class="my-2 p-1 flex border border-gray-200 bg-white rounded">
                        ...
                        <template x-for="selectedItem in selectedItems" :key="selectedItem">
                            <div class="flex justify-center items-center m-1 font-medium py-1 px-2 bg-white rounded-full text-blue-700 bg-blue-100 border border-blue-300 ">
                                <div class="text-xs font-normal leading-none max-w-full flex-initial"
                                     x-text="getSelectedLabel(selectedItem)"></div>
                                <div class="flex flex-auto flex-row-reverse">
                                    <div x-on:click="remove(selectedItem)">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none"
                                             viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"
                                             stroke-linecap="round" stroke-linejoin="round"
                                             class="feather feather-x cursor-pointer hover:text-blue-400 rounded-full w-4 h-4 ml-2">
                    ...
                    <div class="text-gray-300 w-8 py-1 pl-2 pr-1 border-l flex items-center border-gray-200">
                        <button x-on:click.prevent="show = !show"
                            ...
                            <svg x-show="!show" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"
            ...
            >
                <div class="flex flex-col w-full">
                    <template x-for="option in Object.entries(isSearching() ? filteredOptions : options)"
                              :key="option[0]">
                        <div
