<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-5">
            <x-jet-red-button wire:click="$toggle('confirmingTeamDeletion')" wire:loading.attr="disabled">
                {{ __('Delete Team') }}
            </x-jet-red-button>
        </div>
        ...
        <x-jet-confirmation-modal wire:model="confirmingTeamDeletion">
            ...
            <x-slot name="footer">
                ...
                <x-jet-red-button class="ml-2" wire:click="deleteTeam" wire:loading.attr="disabled">
                    {{ __('Delete Team') }}
                </x-jet-red-button>
            </x-slot>
