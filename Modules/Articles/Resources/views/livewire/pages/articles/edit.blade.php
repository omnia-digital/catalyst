            ...
            <div class="col-span-4 card">
                <div class="p-6">
                    <div class="mt-4">
                        ...
                        <x-library::input.text class="!bg-white border-gray-600" wire:model="article.title"/>
                        <x-library::input.error for="article.title"/>
                    </div>
                    <div class="mt-6">
                        <x-library::input.label value="URL"/>
                        <x-library::input.text class="!bg-white border-gray-600" wire:model="article.url"/>
                        <x-library::input.error for="article.url"/>
                    </div>
                    <div class="mt-4">
                        <x-library::input.label value="Body"/>
                        <p class="my-4 italic text-primary">You can even use Markdown to style and format your Article!
                        ...
                        <x-library::tiptap wire:model="article.body"/>
