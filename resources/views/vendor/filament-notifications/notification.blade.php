@php
    use Filament\Notifications\Livewire\Notifications;use Filament\Support\Enums\Alignment;
    use Filament\Support\Enums\VerticalAlignment;use function Filament\Support\get_color_css_variables;
            ...
            ...match ($isInline) {
                ...
                false => [
                    ...
                    match ($color) {
                        ...
                        default => 'ring-custom-600/20',
                    },
                ],
            },
        ])
        @style([
            get_color_css_variables($color, shades: [400, 600]) => ! ($isInline || $color === 'gray'),
        ])
>
    <div
            @class([
            ...
            @style([
                get_color_css_variables($color, shades: [50, 400]) => ! ($isInline || $color === 'gray'),
            ])
    >
        @if ($icon = $getIcon())
