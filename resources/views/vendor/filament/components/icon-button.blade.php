...
@php
    ...
    $buttonClasses = \Illuminate\Support\Arr::toCssClasses([
        ...
        match ($color) {
            'gray' => 'text-gray-400 hover:text-gray-500 focus:ring-primary-600',
            default => 'text-custom-500 hover:text-custom-600 focus:ring-custom-600',
        },
    ]);

    $buttonStyles = get_color_css_variables($color, shades: [300, 400, 500, 600]);
    ...
    $badgeClasses = 'absolute start-full top-0 z-[1] -ms-1 -translate-x-1/2 rounded-md bg-white rtl:translate-x-1/2';
