...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-secondary-light text-base font-medium text-secondary-dark bg-secondary-light focus:outline-none focus:text-secondary-dark
