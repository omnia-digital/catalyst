        ...
        >
            ...
            >
                ...
                <trix-toolbar
                        id="trix-toolbar-{{ $id }}"
                        @class([
                            'relative flex flex-col gap-x-3 border-b border-gray-100 px-2.5 py-2',
                ...
                <trix-editor
                        ...
                        {{
                            $getExtraInputAttributeBag()->class([
                                'prose min-h-[theme(spacing.48)] max-w-none !border-none px-3 py-1.5 text-base text-gray-950 focus:outline-none focus-visible:outline-none sm:text-sm sm:leading-6',
                            ])
                        }}
                ></trix-editor>
            </div>
