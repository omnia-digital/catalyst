@php
    use function Filament\Support\prepare_inherited_attributes;$canSelectPlaceholder = $canSelectPlaceholder();
...
>
    ...
    >
        <x-filament::input.select
                ...
                isLoading = false
            "
                :attributes="prepare_inherited_attributes($getExtraInputAttributeBag())"
        >
