            ...
            <div class="flex flex-col overflow-y-auto divide-y">
                <nav class="flex-1 py-4 space-y-1">
                    @foreach ($navigation as $item)
                        <a
                            href="{{ route($item['name']) }}"
                            class="{{ request()->routeIs($item['name']) ? 'bg-gray-200 font-semibold text-black' : 'text-gray-400 hover:text-black hover:bg-gray-200' }} {{ 'w-full pl-6 group flex items-center
                            px-2 py-2
                ...
                <div class="flex-1 p-4 space-y-1">
                    ...
                    <div x-data="setup()">
                        ...
                        <div class="bg-white mx-auto">
                                        ...
                                        @foreach ($invitations as $invitation)
                                            <div class="py-3">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="flex-1">
                                                        <h3 class="mb-2 sm:mb-1 text-gray-800 text-sm font-normal leading-5"><span class="font-bold">{{ $invitation['from'] }}</span> invites you to join <div class="font-bold">{{ $invitation['subject'] }}</div></h3>
                                                    </div>
                                                </div>
                                                <div class="py-3">
                                                    <p class="text-gray-800 text-sm">{{ $invitation['message'] }}</p>
                            ...
                            <div x-show="activeTab===1">Requests</div>
                        </div>
                    </div>
                </div>
            </div>
