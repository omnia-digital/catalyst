        ...
        @if ($game)
            <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
                ...
                <div class="lg:ml-12 xl:mr-64">
                    <x-library::heading.2
                            class="font-semibold text-4xl leading-tight mt-1">{{ $game->details->name }}</x-library::heading.2>
                    ...
                    <div class="flex flex-wrap items-center mt-8">
                            ...
                            <div id="memberRating" class="w-16 h-16 bg-gray-800 rounded-full relative text-sm">
                                @push('scripts')
                                    @include('games::_rating', [
                                        'slug' => 'memberRating',
                                        'rating' => $game->details->memberRating,
                                        'event' => null,
                                    ])
                                @endpush
                            </div>
                        ...
                        <div class="flex items-center ml-12">
                            <div id="criticRating" class="w-16 h-16 bg-gray-800 rounded-full relative text-sm">
                                @push('scripts')
                                    @include('games::_rating', [
                                        'slug' => 'criticRating',
                                        'rating' => $game->details->criticRating,
                                        'event' => null,
                                    ])
                                @endpush
                            </div>
                        ...
                        <div class="flex items-center space-x-4 mt-4 sm:mt-0 sm:ml-12">
                            ...
                            {{--                                        @case (\MarcReichel\IGDBLaravel\Enums\Website\Category::INSTAGRAM)--}}
                            {{--                                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">--}}
                            {{--                                                <a href="{{ $website->url }}" class="hover:text-gray-400">--}}
                            ...
                            {{--                                        @case (\MarcReichel\IGDBLaravel\Enums\Website\Category::TWITTER)--}}
                            {{--                                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">--}}
                            {{--                                                <a href="{{ $website->url }}" class="hover:text-gray-400">--}}
                            ...
                            {{--                                        @case (\MarcReichel\IGDBLaravel\Enums\Website\Category::FACEBOOK)--}}
                            {{--                                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">--}}
                            {{--                                                <a href="{{ $website->url }}" class="hover:text-gray-400">--}}
                    ...
                    <p class="mt-12">{{ $game->details->summary }}</p>
            ...
            >
                <x-library::heading.2 class="text-blue-500 uppercase tracking-wide font-semibold">Images
                </x-library::heading.2>
            ...
            @if ($game->details->screenshots)
                <div class="similar-games-container mt-8">
                    <x-library::heading.2 class="text-blue-500 uppercase tracking-wide font-semibold">Similar Games
                    </x-library::heading.2>
