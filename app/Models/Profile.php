<?php
    ...
    class Profile extends Model
    {
        ...
        {
            return UserFilter::whereUserId($this->id)->whereFilterableType('App\Profile')->whereFilterType('mute')->pluck('filterable_id');
        }
        ...
        {
            return $this->hasManyThrough(Hashtag::class, StatusHashtag::class, 'profile_id', 'id', 'id', 'hashtag_id');
        }
        ...
        {
            return FollowRequest::whereFollowerId($id)->whereFollowingId($this->id)->exists();
        }
