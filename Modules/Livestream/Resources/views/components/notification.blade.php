    ...
    >
        <div class="rounded-lg shadow-xs overflow-hidden">
            <div class="p-4">
                ...
                <a x-show="action" :href="action?.url" x-text="action?.text"
                   class="text-center block bg-white text-gray-600 rounded p-2 mt-2 w-full font-medium hover:text-gray-900"></a>
            </div>
        </div>
    </div>
</div>
