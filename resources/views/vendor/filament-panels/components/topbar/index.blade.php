...
>
    ...
    >
        {{ FilamentView::renderHook('panels::topbar.start') }}
        ...
        >
            {{ FilamentView::renderHook('panels::global-search.before') }}

            @if (filament()->isGlobalSearchEnabled())
                @livewire(Filament\Livewire\GlobalSearch::class, ['lazy' => true])
            @endif

            {{ FilamentView::renderHook('panels::global-search.after') }}
        ...
        {{ FilamentView::renderHook('panels::topbar.end') }}
    </nav>
</div>
