...
namespace Modules\Payments\Http\Livewire\Pages\Subscriptions;

use App\Settings\BillingSettings;
use Livewire\Component;
use Modules\Social\Http\Livewire\Pages\Subscription\Type;
use Modules\Payments\Actions\Salesforce\CreateContactObjectAction;
use Modules\Payments\Actions\Salesforce\GetChargentOrderInfoAction;
use Modules\Payments\Actions\Salesforce\StopRecurringPaymentsOnChargentOrderAction;
...
//            $this->redirect(route('social.home'));
    ...
    {
        return view('payments::livewire.pages.subscription.index');
    }
}
