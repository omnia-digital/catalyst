...
{{--                {{ dd($game) }}--}}
{{--                <a href="{{ route('games.games.show', $game['slug']) }}">--}}
...
{{--                <a href="{{ route('games.games.show', $game['slug']) }}" class="block text-lg font-semibold leading-tight hover:text-gray-400 mt-4">{{ $game['name'] }}</a>--}}
