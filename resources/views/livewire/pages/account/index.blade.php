    ...
    <x-vertical-tabs>
        ...
        <x-slot:panels>
            <x-vertical-tabs.panel>
                ...
                <x-slot:description>Change your account settings.</x-slot>
                ...
                <x-slot:additional>
                    <x-vertical-tabs.panel-section>
                        ...
                        <x-slot:description>{{ \Trans::get('Ensure your account is using a long, random password to stay secure.') }}</x-slot>
                        <div class="mt-6 grid grid-cols-4 gap-6">
