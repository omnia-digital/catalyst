<div>
    ...
    @endif
    <div class="max-w-8xl mx-auto grid grid-cols-10 gap-2 bg-neutral @hasSection('full-width-header') pt-4 @else pt-6 @endif">
        <!-- SideMenu -->
        ...
        <div class="col-span-8">
            <div class="">
                ...
                {{--                        <x-library::heading.1 class="py-4 ml-4">Community</x-library::heading.1>--}}
