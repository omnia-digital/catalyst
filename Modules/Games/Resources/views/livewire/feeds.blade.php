    ...
    <div class="w-full mb-4">
        <div class="relative shadow-xl sm:rounded-b-2xl sm:overflow-hidden">
            ...
            <div class="relative px-4 py-8 md:py-16 sm:px-6 sm:py-16 lg:py-16 lg:px-8">
                <x-library::heading.1 class="text-center uppercase" text-size="text-3xl md:text-5xl">{{ Trans::get('News Feeds') }}</x-library::heading.1>
                <p class="mt-2 md:mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">Browse what's happening right now in gaming news.</p>
                </p>
            </div>
        </div>
    </div>
