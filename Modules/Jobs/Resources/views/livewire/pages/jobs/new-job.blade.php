                        ...
                        <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                            ...
                            <div class="grid grid-cols-3 gap-6">
                                ...
                                <div class="col-span-3 space-y-1 sm:col-span-2">
                                    ...
                                    <x-library::input.text wire:model.live="location" id="location" placeholder="Location"/>
                                ...
                                <div class="col-span-3 space-y-1 sm:col-span-2">
                                    ...
                                    @foreach ($experienceLevels as $key => $experience)
                                        <div class="flex pt-4">
                                            <x-jobs::input.radio wire:model="experience_level_id"
                                ...
                                <div class="col-span-3 space-y-1 sm:col-span-2">
                                    ...
                                    @foreach ($jobLengths as $key => $jobLength)
                                        <div class="flex pt-4">
                                            <x-jobs::input.radio wire:model="job_length_id" name="job_length_id"
                                                                 id="{{ $jobLength['title'] }}"
                                                                 value="{{ $jobLength['id'] }}"/>
                                            <x-library::input.label class="pl-4 font-bold"
                                    ...
                                    @foreach ($projectSizes as $key => $project)
                                        <div class="flex pt-4">
                                            <x-jobs::input.radio wire:model="project_size_id"
                                ...
                                @auth
                                    <div class="col-span-3 space-y-1">
                                        ...
                                        <div class="inline-flex items-center">
                                            <x-jobs::input.file wire:model.live="logo" id="logo"
                                                                :preview="$logo ? $logo->temporaryUrl() : Auth::user()->currentTeam->logoUrl"
                                                                class="mr-4"/>
                                            <x-jobs::input.company wire:model.live="team_id" :companies="$companies"
                                                                   id="company"/>
                                        </div>
                                    ...
                                    >
                                        <fieldset>
                                            ...
                                            <div class="mt-2 bg-white rounded-md -space-y-px">
                                                ...
                                                >
                                                    <x-jobs::input.radio x-model="paymentMethod" value="new-card"
                                                                         id="new-card"/>
                                            ...
                                            >
                                                ...
                                                @if (Auth::user()->hasDefaultPaymentMethod())
                                                    ...
                                                    >
                                                        <x-jobs::input.radio x-model="paymentMethod"
                                                                             value="previous-card" id="previous-card"/>
