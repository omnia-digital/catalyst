...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-secondary-light text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-secondary-dark transition'
