<x-library::modal id="create-team">
    ...
    <x-slot name="content">
        <div>
            ...
            <x-library::input.text wire:model.live="name" class="bg-secondary" placeholder="{{ \Trans::get('Enter your Team Name') }}" required/>
...
{{--            </div>--}}
{{--            <x-library::input.date wire:model.live="startDate" placeholder="{{ \Trans::get('Team Launch Date') }}"/>--}}
