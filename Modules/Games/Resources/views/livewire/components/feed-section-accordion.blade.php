        ...
        <div class="space-y-4">
            <div class="accordion accordion-flush" id="accordion-{{ \Str::slug($feed->get_title()) }}">
                <div class="accordion-item">
                    <h2 class="accordion-header mb-0" id="flush-heading-{{ \Str::slug($feed->get_title()) }}">
                        <button class="accordion-button
                                        ...
                                        transition
                                        focus:outline-none
                                      " type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-{{ \Str::slug($feed->get_title()) }}" aria-expanded="false"
                                aria-controls="flush-collapse-{{ \Str::slug($feed->get_title()) }}">
                            <div>
