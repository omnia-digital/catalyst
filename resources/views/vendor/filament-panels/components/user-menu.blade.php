@php
    use Filament\Support\Facades\FilamentView;use function Filament\Support\prepare_inherited_attributes;$user = filament()->auth()->user();
...
{{ FilamentView::renderHook('panels::user-menu.before') }}
...
>
    ...
    @if ($profileItem?->isVisible() ?? true)
        {{ FilamentView::renderHook('panels::user-menu.profile.before') }}
        ...
        {{ FilamentView::renderHook('panels::user-menu.profile.after') }}
    @endif
...
{{ FilamentView::renderHook('panels::user-menu.after') }}
