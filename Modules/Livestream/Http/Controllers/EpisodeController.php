...
use App\Omnia;
use App\Http\Requests\Notifications\Aws\S3NotificationRequest;
...
use App\Actions\CreateNewEpisodeFromUploadedVideo;
...
use App\Http\Requests\EpisodeScheduleLiveVideoRequest;
...
use App\Interactions\DeleteEpisodeThumbnail;
use App\Interactions\UpdateEpisodeThumbnail;
use App\Jobs\Episode\DownloadEpisodes;
use App\Jobs\ProcessLiveVideos;
...
class EpisodeController extends LivestreamController
{
    ...
    {
        return Episode::where('livestream_account_id', $this->_livestreamAccount->id)->orderBy('date_recorded', 'desc')->first();
    }
