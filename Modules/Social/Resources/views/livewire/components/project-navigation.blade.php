<nav class="bg-gray-300 flex relative">
    ...
    <div class="flex justify-between items-center w-full ml-32 relative z-10">
        ...
        <div class="flex">
            ...
            <livewire:social::partials.follow-button :model="$project" class="py-4 mx-4"/>
            <div class="inline-flex items-center text-md">
                <button class="p-2 mx-2 inline-flex items-center text-sm rounded-full bg-primary">Apply</button>
            </div>
            <div class="inline-flex items-center text-md">
