<x-library::modal id="create-company">
    ...
    <x-slot name="content">
        <div>
            ...
            <x-library::input.text wire:model.defer="name" class="bg-secondary" placeholder="{{ \Trans::get('Enter your Company Name') }}" required/>
            <x-library::input.error for="name"/>
        </div>
        <div class="mt-6">
            <div class="flex items-center">
                <x-library::input.label value="{{ \Trans::get('What is your Company associated with?') }}" /><span class="text-red-600 text-sm ml-1">*</span>
            </div>
            <p class="text-neutral-dark">{{ \Trans::get('(you can choose more than one)') }}</p>
            <x-library::input.selects wire:model="companyTypes" :options="$companyTags"/>
        </div>
{{--        <div class="mt-6">--}}
...
{{--            <x-library::input.selects wire:model="companyFocus" :options="$companyFocuses" max="1"/>--}}
{{--        </div>--}}
{{--        <div class="mt-6">--}}
{{--            <div class="flex items-center">--}}
{{--                <x-library::input.label value="{{ \Trans::get('Start Date (can be changed later)') }}"/><span class="text-red-600 text-sm ml-1">*</span>--}}
{{--            </div>--}}
{{--            <x-library::input.date wire:model.defer="startDate" placeholder="{{ \Trans::get('Company Launch Date') }}"/>--}}
