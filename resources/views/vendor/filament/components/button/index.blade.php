@php
    ...
    use Filament\Support\Enums\IconSize;use function Filament\Support\get_color_css_variables;use function Filament\Support\prepare_inherited_attributes;
@endphp
...
@php
        ...
        ...(
            $outlined ?
                [
                    ...
                    match ($color) {
                        'gray' => 'text-gray-950 ring-gray-300 hover:bg-gray-400/10 focus:ring-gray-400/40',
                ...
                [
                    ...
                    ...match ($color) {
                        ...
                        default => [
                            ...
                            'focus:ring-custom-500/50' => ! $grouped,
                        ],
                    },
                ]
        ),
    ...
    $badgeClasses = 'absolute -top-1 start-full z-[1] -ms-1 -translate-x-1/2 rounded-md bg-white rtl:translate-x-1/2';
