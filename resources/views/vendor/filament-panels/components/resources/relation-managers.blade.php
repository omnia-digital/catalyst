        ...
        >
            ...
            @if ($managers[$activeManager] instanceof RelationGroup)
                @foreach ($managers[$activeManager]->ownerRecord($ownerRecord)->pageClass($pageClass)->getManagers() as $groupedManager)
                    ...
                    @livewire(
                        ...
                        [...$managerLivewireProperties, ...(($groupedManager instanceof RelationManagerConfiguration) ? $groupedManager->properties : [])],
            ...
            @else
                ...
                @livewire(
                    ...
                    [...$managerLivewireProperties, ...(($manager instanceof RelationManagerConfiguration) ? $manager->properties : [])],
