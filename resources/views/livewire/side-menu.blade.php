                    ...
                    <nav class="px-2 space-y-1">
                        @foreach ($navigation as $item)
                            <a
                                ...
                                class="{{ request()->routeIs($item['name']) ? 'bg-secondary text-primary' : 'text-light-text-color hover:bg-neutral-dark hover:text-primary' }} {{ 'group flex items-center px-2 py-2 text-base-text-color font-medium' }}">
            ...
            <a href="{{ route('social.home') }}">
                <div class="flex-shrink-0 pl-6 flex p-4">
                    <div class="flex flex-col justify-center items-center">
                        ...
                        <div class="bg-secondary flex items-center rounded-md -m-2 p-1">
                            <div class="bg-primary text-xxs rounded-md p-1">
                                {{ Auth::user()->level ?? '48' }}
                            </div>
                            <div class="text-xxs text-primary p-1">
