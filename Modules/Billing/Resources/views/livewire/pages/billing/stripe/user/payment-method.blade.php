        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            @if ($this->stripeBillable()->hasDefaultPaymentMethod())
                ...
                >
                    ...
                    <div class="mt-4 sm:mt-0 sm:ml-6 sm:flex-shrink-0">
                        <x-jet-button x-on:click="editMode = true">Edit</x-jet-button>
                    </div>
                </div>
            @endif
            ...
            @if ($this->stripeBillable()->hasDefaultPaymentmethod())
                <div x-show="editMode" class="flex items-center text-gray-700 mt-4" style="display: none">
                    ...
                    <a x-on:click.prevent="editMode = false" href="#" class="underline">Nevermind, I will keep my current payment method.</a>
                </div>
            @endif
        </div>
    </div>
