...
>
    ...
    <div x-show="show" class="fixed z-50 inset-0 overflow-hidden flex items-center justify-center w-full h-full p-4"
         style="display: none;">
        ...
        >
            <form wire:submit.prevent="{{ $submit }}"
                  class="max-h-full flex-1 overflow-y-auto flex flex-col sm:flex-row">
                <div class="absolute top-0 right-0 pt-4 pr-4">
                    <button x-on:click="show = false" type="button"
                            class="text-gray-400 bg-white rounded-md dark:bg-mirage-900 dark:text-white focus:outline-none"
                            aria-label="Close">
                ...
                <div class="max-h-full sm:ml-4 flex-1">
                    ...
                    <div class="mt-5 sm:mt-4 mb-4 sm:mb-6 sm:flex">
                        <div class="flex items-center justify-center w-full space-x-2 sm:justify-end px-1">
                            <button x-on:click="show = false" type="button"
                                    class="inline-flex items-center px-3 py-2 border-gray-300 bg-white hover:bg-gray-50 focus:ring-red-500 dark:bg-mirage-800 dark:border-mirage-500 dark:hover:bg-mirage-900 dark:hover:border-mirage-600 border border-transparent rounded cursor-pointer shadow-sm hover:shadow-lg transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-mirage-500">
                                Cancel
                            </button>
                            <x-form.button-destruction type="submit">Confirm</x-form.button-destruction>
                        </div>
                    </div>
                </div>
            </form>
