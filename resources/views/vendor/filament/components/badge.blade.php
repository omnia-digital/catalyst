...
@php
    use Filament\Support\Enums\IconPosition;use function Filament\Support\get_color_css_variables;
            ...
            $attributes
                ->class([
                    ...
                    match ($color) {
                        ...
                        default => 'bg-custom-50 text-custom-600 ring-custom-600/10',
                    },
                ])
                ->style([
...
>
    ...
    @if ($isDeletable)
        <button
                type="button"
                class="-my-1 -me-2 -ms-1 flex items-center justify-center p-1 text-custom-700/50 outline-none transition duration-75 hover:text-custom-700/75 focus:text-custom-700/75"
