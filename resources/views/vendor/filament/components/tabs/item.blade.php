...
@php
    ...
    $inactiveItemClasses = 'text-gray-500 hover:text-gray-700 focus:text-gray-700';

    $activeItemClasses = 'fi-tabs-item-active bg-gray-50 text-primary-600';
...
{{
    $attributes
        ...
        ->class([
            'fi-tabs-item flex items-center gap-x-2 rounded-lg px-3 py-2 text-sm font-medium font-medium outline-none transition duration-75 hover:bg-gray-50 focus:bg-gray-50',
