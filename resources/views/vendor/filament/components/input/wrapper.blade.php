...
@php
    ...
    $disabledWrapperClasses = 'bg-gray-50';
    $validWrapperClasses = 'ring-gray-950/10';
    $invalidWrapperClasses = 'ring-danger-600';
    ...
    $iconClasses = 'fi-input-wrapper-icon h-5 w-5 text-gray-400';
    $labelClasses = 'fi-input-wrapper-label whitespace-nowrap text-sm text-gray-500';
