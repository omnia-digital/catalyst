    ...
    <div class="relative z-10 flex-shrink-0 h-16 bg-white border-b border-gray-200 shadow-sm flex">
        ...
        <div class="flex-1 flex justify-between px-4 sm:px-6">
            ...
            <!-- Profile dropdown -->
                ...
                >
                    <div>
                        <button x-on:click="show = true" type="button" class="bg-white rounded-full flex text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    >
                        ...
                        @if (Auth::user()->isAdmin())
                            <x-jet-dropdown-link href="{{ url(config('nova.path')) }}">
                                {{ __('Admin') }}
                            </x-jet-dropdown-link>
