...
<div class="h-10 px-4 text-sm bg-neutral flex items-center justify-between">
    <div class="flex items-center pr-3">
        <x-library::dropdown.index :position="'left'" class="z-10 py-2 rounded-md bg-neutral" :dropdownClasses="'bg-secondary border-none shadow-md'">
    ...
    <div class="flex items-center">
        <x-library::dropdown.index :position="'right'" class="z-10 py-2 rounded-md bg-neutral" :dropdownClasses="'bg-secondary border-none shadow-md sm:w-48'">
