@php
    use Filament\Support\Facades\FilamentView;$navigation = filament()->getNavigation();
@endphp
...
<x-filament-panels::layout.base :livewire="$livewire">
    <div class="fi-layout flex min-h-screen w-full overflow-x-clip">
        ...
        >
            ...
            >
                {{ FilamentView::renderHook('panels::content.start') }}

                {{ $slot }}

                {{ FilamentView::renderHook('panels::content.end') }}
            </main>

            {{ FilamentView::renderHook('panels::footer') }}
        </div>
    </div>
