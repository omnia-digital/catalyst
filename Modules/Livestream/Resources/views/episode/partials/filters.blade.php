    ...
    <div class="flex-1 min-w-0">
        <div class="filters flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6">
            <div class="w-full md:w-2/3 relative">
                <x-input.text type="search" wire:model.debounce.500ms="search" placeholder="Find episodes" class="px-4 py-2 pl-8"/>
            ...
            <div class="w-full md:w-1/3">
                <x-input.date wire:model="filters.date_recorded" placeholder="Recorded Date"/>
            </div>
            <div class="w-full md:w-1/3 flex items-center space-x-2">
                <x-input.toggle wire:model="filters.has_attachment"/>
