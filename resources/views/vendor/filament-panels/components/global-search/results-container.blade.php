...
<div
        ...
        {{
            $attributes->class([
                'fi-global-search-results-ctn absolute end-0 z-10 mt-2 max-h-96 w-screen max-w-sm overflow-auto rounded-lg bg-white shadow-lg ring-1 ring-gray-950/5 transition',
            ])
        }}
>
