            ...
            <div class="p-4">
                <div class="flex items-start">
                    <div class="flex-shrink-0">
                        <svg class="h-6 w-6 text-white-text-color" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="ml-4 flex-shrink-0 flex">
                        <button @click="show = false" class="inline-flex text-white-text-color focus:outline-none focus:text-base-text-color transition ease-in-out duration-150">
