...
<li {{ $attributes->merge(['class' => 'relative']) }}>
    <div class="group block aspect-w-10 aspect-h-7 w-full relative overflow-hidden rounded-lg  cursor-pointer">
        ...
        <div class="px-4 py-4 transition-transform ease-in-out bg-neutral-dark hover:translate-y-1 hover:scale-y-150 hover:bg-secondary duration-75">
            <h4 class="mb-3 text-xl font-semibold tracking-tight text-primary">{{ $item->title }}</h4>
        </div>
    </div>
...
{{--                <div class="flex items-center w-16 h-4 bg-dark-text-color py-3 rounded-md text-center opacity-80">--}}
{{--                    <div class="ml-2 w-3 h-3 bg-red-600 rounded-full"></div>--}}
{{--                    <p class="text-xs ml-1 uppercase text-primary font-medium">Live</p>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        @endif--}}
{{--    </div>--}}
