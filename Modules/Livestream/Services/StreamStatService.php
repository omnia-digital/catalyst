...
//					$statCollection->put('playback_vod', $this->getVodPlaybackBandwidthEvents($livestream_account_id));
	 ...
	 */
	public function getEventsFromWowza($event_type = null, $livestream_account_id = null, $app_name = null, $deleteRecords = false)
	{
	 ...
	 */
	public function getPublishEvents($event_type = 'unpublish', $livestream_account_id = null, $app_name = null, $deleteRecords = false)
	{
		try {
	 ...
	 */
	public function getPlaybackEvents($app_type = null, $event_type = 'stop', $livestream_account_id = null, $deleteRecords = false)
	{
	...
	public function postStorageStats($livestream_account_id = null)
	{
		...
		if (!is_null($livestream_account_id)) {
            ...
            Artisan::call('livestream-get-storage-size', ['livestream_account_id' => $livestream_account_id], $totalStorageSize);
			...
			foreach($allDirectories as $accountDirectory) {
                Artisan::call('livestream-get-storage-size', ['livestream_account_id' => $accountDirectory], $totalStorageSize);
                $livestream_video_storage_events->push([
