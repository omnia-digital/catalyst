    ...
    <x-library::modal id="add-article-modal" maxWidth="5xl">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                ...
                <p class="my-4 italic text-primary">You can even use Markdown to style and format your Article! Not sure
                    how to use it? Here's the official guide: <a href="https://www.markdownguide.org/basic-syntax/"
