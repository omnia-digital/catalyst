    ...
    'team_member_subscriptions' => [
        ...
        'plans'                   => [
            [
                ...
                'price'       => 4.99,
                'description' => Trans::get("Support every month and Subscribe to help the owner of this Team keep doing what they're doing"),
                'features'    => [
            ...
            [
                ...
                'price'       => 9.99,
                'description' => Trans::get("Support that little extra to help the stream grow with some extras as a thanks."),
                'features'    => [
                    'All Tier 1 Benefits',
            ...
            [
                ...
                'price'       => 24.99,
                'description' => Trans::get("Go way above the call of duty and get some extra special exclusives in return."),
                'features'    => [
                    'All Tier 2 Benefits',
                    'Free Sub to gift to someone else',
                ],
