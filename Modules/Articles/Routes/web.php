...
Route::name('articles.')->prefix('articles')->middleware([GuestAccessMiddleware::class, 'verified'])->group(function (
    ...
    Route::get('drafts',
        ArticlesDrafts::class)->middleware(['auth'])->withoutMiddleware([GuestAccessMiddleware::class])->name('drafts');
    Route::get('published',
        ArticlesPublished::class)->middleware(['auth'])->withoutMiddleware([GuestAccessMiddleware::class])->name('published');
