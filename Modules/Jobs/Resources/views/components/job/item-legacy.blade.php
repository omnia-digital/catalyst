...
<li {{ $attributes }}>
    <a href="{{ $editable ? route('jobs.update', $job) : $job->applyLink }}" target="{{ $editable ? '_self' : '_blank' }}" class="block hover:bg-light-blue-50 hover:shadow-2xl focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out">
