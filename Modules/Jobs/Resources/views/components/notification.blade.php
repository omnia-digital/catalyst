            ...
            <div class="p-4">
                <div class="flex items-start">
                    ...
                    <div class="ml-3 w-0 flex-1 pt-0.5">
                        <p x-text="message" class="text-sm leading-5 font-medium text-primary"></p>
                    </div>
                    <div class="ml-4 flex-shrink-0 flex">
                        <button @click="show = false" class="inline-flex text-primary focus:outline-none focus:text-base-text-color transition ease-in-out duration-150">
