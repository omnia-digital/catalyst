            ...
            <div class="bottom-0 border-t border-gray-100 inset-x-0 pl-3 pr-2 pt-2 flex flex-wrap justify-between">
                    ...
                    {{-- <div class="flex items-center">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                >
                                    <ul class="absolute z-10 mt-1 -ml-6 w-60 bg-primary shadow rounded-lg py-3 text-base ring-1 ring-black ring-opacity-5 focus:outline-none sm:ml-auto sm:w-64 sm:text-sm">
                ...
                <div class="flex-shrink-0">
                    <button
                        ...
                        type="submit" class="w-full block text-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-primary hover:bg-gray-50"
                    >
                        Post
                    </button>
                </div>
