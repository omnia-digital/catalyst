@php
    ...
    use Filament\Support\Contracts\HasLabel;use Filament\Support\Enums\FontFamily;
    use Filament\Support\Enums\FontWeight;
    use Filament\Support\Enums\IconPosition;use Illuminate\Support\Collection;use function Filament\Support\get_color_css_variables;use function Filament\Support\prepare_inherited_attributes;
@endphp
        ...
        @foreach ($arrayState as $state)
            @if (filled($formattedState = $formatState($state)))
                @php
                    ...
                    $iconStyles = \Illuminate\Support\Arr::toCssStyles([
                        get_color_css_variables($color, shades: [500]) => $color !== 'gray',
                    ]);
                @endphp
            ...
            @else
                <div
                        ...
                        @style([
                            get_color_css_variables($color, shades: [400, 600]) => ! in_array($color, [null, 'gray']),
                        ])
                >
